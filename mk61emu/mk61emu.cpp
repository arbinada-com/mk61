...
//    mtick_t signal_E = (mtick >> 2) % 3;
    ...
    if (MOD == 0 || (mtick >> 2) >= 36)
    {
        ...
        {
            case 1: R[signal_I] = R[(signal_I + 3) % 42]; break;
...
void MK61Emu::ReadNumber(mk61_register_t &reg, uint8_t chip, unsigned char address)
{
	...
	switch (chip)
	{
        case 1: m = m_IR2_1->M; break;
        case 2: m = m_IR2_2->M; break;
        case 3: m = m_IK1302->M; break;
        case 4: m = m_IK1303->M; break;
        default: m = m_IK1306->M; break;  /*case 5*/
	}
	// порядок числа
	// 0123456789012
	// -1.2345678-99
